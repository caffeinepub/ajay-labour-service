...
export class Backend implements backendInterface {
    ...
    async addServiceArea(arg0: string, arg1: number, arg2: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addServiceArea(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllServiceAreas(): Promise<Array<ServiceArea>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllServiceAreas();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
